...
export const FiltersSchema = z.object({
    ...
    firstDestination: z.object({
        ...
        airport: z
            .string()
            .describe('The IATA airport code corresponding to the city of the team that user wants to travel to first'),
        league: z
            .string()
            .describe(
    ...
    countries: z
        .array(z.string())
        .describe('List of countries of the destinations. should include the country name like "Spain" or "England"'),
    destinations: z
        .array(
            z.object({
                ...
                distance: z
                    .number()
                    .describe('The distance between the team and the first destination airport. in Kilometers Unit'),
                description: z
                    .string()
                    .describe('A description of why this destination is recommended for the user based on his prompt'),
            })
        )
        .describe(
